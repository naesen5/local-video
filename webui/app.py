            ...
            with gr.Tab("Text-to-Video"):
                ...
                with gr.Row():
                    with gr.Column():
                        ...
                        generate_txt_btn = gr.Button("Generate Video", variant="primary")
            ...
            with gr.Tab("Image-to-Video"):
                ...
                with gr.Row():
                    with gr.Column():
                        ...
                        generate_img_btn = gr.Button("Generate Video", variant="primary")
                ...
                generate_img_btn.click(
                    ...
                    inputs=[input_image, prompt_img_txt, model_img_dd, num_frames_img_sl],
